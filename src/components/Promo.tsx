...
const Promo = () => {
  return (
    <div className="w-full h-[600px] lg:h-[500px] flex-center-center py-0 lg:py-16">
      <div className="w-full lg:w-[80%] h-full lg:h-[350px] flex flex-col lg:flex-row bg-container-promo rounded-2xl pt-6 lg:pt-0">
        <div className="w-full lg:w-[60%] h-full flex-center-center flex-col px-6 py-6 lg:py-0">
          <p className="text-4xl text-center text-primary font-semibold leading-relaxed">
        ...
        <div className="w-full lg:w-[40%] h-full flex justify-center items-end overflow-clip">
          <div className="w-[200px] h-[180px] lg:w-[300px] lg:h-[270px] bg-transparent relative">
            <div className="w-[200px] h-[200px] lg:w-[300px] lg:h-[300px] bg-secondary rounded-full"></div>
            <img
