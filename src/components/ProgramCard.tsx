...
const ProgramCard = ({ list }: ProgramCardProps) => (
  <div
    className={`${list.color} w-[310px] h-[330px] rounded-3xl outline outline-4 outline-slate-100 overflow-clip select-none`}
  >
    ...
    <div className="bg-gradient-to-b from-slate-50 to-sky-300 h-full rounded-xl p-4">
